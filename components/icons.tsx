...
export const ShetiManLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M30 75C30 55 50 45 50 45S70 55 70 75C70 90 50 95 50 95S30 90 30 75Z" fill="#81C784"/>
  </svg>
);
...
export const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M17.61,2.26a.5.5,0,0,0-.43-.15.5.5,0,0,0-.22.05C13.4,3.7,12.18,5.88,12,8.5c0,0-1-3.5-4.5-4.5S1.75,5.13,2,8.5,4,14.5,4,14.5,3.5,18,6,20.5s4.5,1.5,4.5,1.5,1.5-2,1.5-4.5S10.5,14,12,12.5s3-2,5-2.5,4.5-2,4.5-4.5S19.64,1.4,17.61,2.26Z"/>
  </svg>
);
...
export const QRIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
// Added fix for missing icons: UploadIcon
...
// Added fix for missing icons: SunIcon
...
// Added fix for missing icons: CloudIcon
...
// Added fix for missing icons: RainIcon
export const RainIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20 16.242c0-4.522-3.582-8.182-8-8.182s-8 3.66-8 8.182c0 1.547.43 3 1.17 4.242" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v3m4-3v2m-8-2v2" />
  </svg>
);

// Added fix for missing icons: WindIcon
...
// Added fix for missing icons: ThermometerIcon
export const ThermometerIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19c0 1.105.895 2 2 2s2-.895 2-2H9zM12 3a3 3 0 00-3 3v8.17a5 5 0 106 0V6a3 3 0 00-3-3z" />
  </svg>
);

// Added fix for missing icons: DropletIcon
...
// Added fix for missing icons: DocumentScannerIcon
...
// Added fix for missing icons: PackageIcon
export const PackageIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14v4m0 0l8 4m-8-4l-8 4m8 4v10" />
  </svg>
);

// Added fix for missing icons: CheckSquareIcon
...
// Added fix for missing icons: ClipboardListIcon
