...
import { Camera, Upload, Volume2, FlaskConical, Sparkles, X } from 'lucide-react';
...
const SoilAnalyzer: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 pt-4 pb-24 animate-fade-in max-w-4xl">
      <div className="mb-8">
        <h2 className="text-4xl font-black text-secondary tracking-tighter">{t('soilAnalyzer.title')}</h2>
        <p className="text-sm text-gray-400 font-bold uppercase tracking-widest mt-1">AI Soil Health Scan</p>
      </div>
                    ...
                    <div className="relative w-full h-full">
                      ...
                      {loading && (
                        <div className="absolute inset-0 bg-white/80 backdrop-blur-md flex items-center justify-center z-20">
                          <AiThinkingLoader label="Analyzing Soil Sample..." />
                        </div>
                      )}
                      <button 
                        onClick={clearImage}
