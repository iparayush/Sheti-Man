...
import { UploadIcon, SpeakerIcon, ScienceIcon, LeafIcon } from './icons';
...
const SoilAnalyzer: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 animate-fade-in max-w-lg pb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-black text-secondary tracking-tighter leading-none">{t('soilAnalyzer.title')}</h2>
        <p className="text-sm text-gray-400 font-bold mt-2 uppercase tracking-wider">AI Soil Health Scan</p>
      </div>
      ...
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-black/5 flex flex-col items-center relative overflow-hidden">
                    ...
                    <div className="relative w-full h-full">
                      ...
                      {loading && (
                        <div className="absolute inset-0 bg-primary/20 backdrop-blur-[2px] flex items-center justify-center">
                          <ThinkingState label="Analyzing Soil..." />
                        </div>
                      )}
            ...
            <div className="w-full space-y-4">
              ...
              >
                  {loading ? 'Processing...' : t('cropDoctor.submitButton')}
              </button>
            </div>
        </div>
